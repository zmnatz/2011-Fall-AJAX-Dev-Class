 ...
 * @param numRows (optional) Hard codes the number of rows of data to show
 */
function buildTable(headings, rows, outputEl,numRows) {
	/**
	...
	//Set num rows to the number of rows if not explicitly set
	numRows = numRows ? numRows : rows.length;	
